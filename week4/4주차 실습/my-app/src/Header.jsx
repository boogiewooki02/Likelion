      ...
      <div className="header-bar">
        ...
        <div className="search-bar">
          ...
          <button className='search-button'>
            <img src={searchImage} alt='img' style={{cursor: 'pointer'}} />
          </button>
          <button type='button' className='chat-button'>채팅하기</button>
          <button className='search-button menu-button'>
            <img src={menuImage} alt='img' style={{cursor: 'pointer'}} />
          </button>
        </div>
      </div>
